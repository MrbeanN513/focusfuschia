...
void main() => runApp(FocusFuchsia());

class FocusFuchsia extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _FocusFuchsia();
  }
}

class _FocusFuchsia extends State<FocusFuchsia> {
              ...
              children: [
                SingleChildScrollView(
                  ...
                  child: Row(
                    children: [
                      FuchsiaButton(
                          handleEnterTapAction: _handleEnterTapAction,
                          height: 120,
                          width: 120,
